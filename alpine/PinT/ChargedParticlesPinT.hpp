...
public:
    ...
    void initNUFFTs(FieldLayout_t& FLPIF, double& coarseTol,
        ...
        ippl::ParameterList fftCoarseParams1,fftFineParams1,fftFineParams2,fftCoarseParams2;
        ...
        fftFineParams1.add("use_finufft_defaults", false);
        fftCoarseParams1.add("use_finufft_defaults", false);
        fftFineParams2.add("use_finufft_defaults", false);
        fftCoarseParams2.add("use_finufft_defaults", false);
        
        nufftType1Fine_mp = std::make_shared<ippl::FFT<ippl::NUFFTransform, 3, double>>(FLPIF, this->getLocalNum(), 1, fftFineParams1);
        nufftType2Fine_mp = std::make_shared<ippl::FFT<ippl::NUFFTransform, 3, double>>(FLPIF, this->getLocalNum(), 2, fftFineParams2);

        nufftType1Coarse_mp = std::make_shared<ippl::FFT<ippl::NUFFTransform, 3, double>>(FLPIF, this->getLocalNum(), 1, fftCoarseParams1);
        nufftType2Coarse_mp = std::make_shared<ippl::FFT<ippl::NUFFTransform, 3, double>>(FLPIF, this->getLocalNum(), 2, fftCoarseParams2);
    }
