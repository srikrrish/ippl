...
namespace ippl {
    ...
    void FFTPeriodicPoissonSolver<Tl,Tr,Dim,M,C>::initialize() {
        ...
        fft_mp = std::make_shared<FFT_t>(layout_r, *layoutComplex_mp,
                                         this->params_m);
    }
    ...
    void FFTPeriodicPoissonSolver<Tl,Tr,Dim,M,C>::solve() {
        ...
        switch (this->params_m.template get<int>("output_type")) {
            ...
            case Base::SOL: {
              ...
              Kokkos::parallel_for("Solution FFTPeriodicPoissonSolver",
            ...
            case Base::GRAD:{
                ...
                for(size_t gd = 0; gd < Dim; ++gd) {
                    ...
                    Kokkos::parallel_for("Gradient FFTPeriodicPoissonSolver",
                                        mdrange_type({nghost, nghost, nghost},
                                                     {view.extent(0) - nghost,
                                                      view.extent(1) - nghost,
                                                      view.extent(2) - nghost}),
                    ...
                    Kokkos::parallel_for("Assign Gradient FFTPeriodicPoissonSolver",
                                        mdrange_type({nghostL, nghostL, nghostL},
                                                     {viewLhs.extent(0) - nghostL,
                                                      viewLhs.extent(1) - nghostL,
            ...
            default:
                throw IpplException("FFTPeriodicPoissonSolver::solve",
